                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        ...
                        className="bg-zinc-300/50 dark:bg-zinc-800/80 border-0 focus-visible: ring-0 text-black dark:text-zinc-300/50 focus-visible:ring-offset-0"
                        {...field}
                      />
                    </FormControl>
                    <FormMessage />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    >
                      <FormControl>
                        <SelectTrigger className="bg-zinc-300/50 dark:bg-zinc-800/80 border-0 focus:ring-0 text-black dark:text-zinc-300/50 ring-offset-0 focus:ring-offset-0 capitalize outline-none">
